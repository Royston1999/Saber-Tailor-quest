...
void SaberTailor::Views::SaberTailorLeftHand::DidActivate(
    ...
    if (firstActivation) {
        ...
        posX = SaberTailor::IncrementSlider::CreateIncrementSlider(leftsabercontainer->get_transform(), "Position X", 0.1f, SaberTailorMain::config.leftPosX, -10, 10, [](float value){
            ...
            posX->sliderComponent->slider->GetComponentInChildren<TMPro::TextMeshProUGUI*>()->set_text(IncrementHelper::Round(SaberTailorMain::config.leftPosX, 1) + " cm");
        });
        posY = SaberTailor::IncrementSlider::CreateIncrementSlider(leftsabercontainer->get_transform(), "Position Y", 0.1f, SaberTailorMain::config.leftPosY, -10, 10, [](float value){
            ...
            ConfigHelper::LoadConfig(SaberTailorMain::config, getConfig().config);
            posY->sliderComponent->slider->GetComponentInChildren<TMPro::TextMeshProUGUI*>()->set_text(IncrementHelper::Round(SaberTailorMain::config.leftPosY, 1) + " cm");
        });
        posZ = SaberTailor::IncrementSlider::CreateIncrementSlider(leftsabercontainer->get_transform(), "Position Z", 0.1f, SaberTailorMain::config.leftPosZ, -10, 10, [](float value){
            ...
            ConfigHelper::LoadConfig(SaberTailorMain::config, getConfig().config);
            posZ->sliderComponent->slider->GetComponentInChildren<TMPro::TextMeshProUGUI*>()->set_text(IncrementHelper::Round(SaberTailorMain::config.leftPosZ, 1) + " cm");
        });
        rotX = SaberTailor::IncrementSlider::CreateIncrementSlider(leftsabercontainer->get_transform(), "Rotation X", 1, SaberTailorMain::config.leftRotX, -180, 180, [](float value){
            ...
            ConfigHelper::LoadConfig(SaberTailorMain::config, getConfig().config);
            rotX->sliderComponent->slider->GetComponentInChildren<TMPro::TextMeshProUGUI*>()->set_text(std::to_string(SaberTailorMain::config.leftRotX) + " deg");
        });
        rotY = SaberTailor::IncrementSlider::CreateIncrementSlider(leftsabercontainer->get_transform(), "Rotation Y", 1, SaberTailorMain::config.leftRotY, -180, 180, [](float value){
            ...
            ConfigHelper::LoadConfig(SaberTailorMain::config, getConfig().config);
            rotY->sliderComponent->slider->GetComponentInChildren<TMPro::TextMeshProUGUI*>()->set_text(std::to_string(SaberTailorMain::config.leftRotY) + " deg");
        });
        ...
        rotZ = SaberTailor::IncrementSlider::CreateIncrementSlider(leftsabercontainer->get_transform(), "Rotation Z", 1, SaberTailorMain::config.leftRotZ, -180, 180, [](float value){
            ...
            ConfigHelper::LoadConfig(SaberTailorMain::config, getConfig().config);
            rotZ->sliderComponent->slider->GetComponentInChildren<TMPro::TextMeshProUGUI*>()->set_text(std::to_string(SaberTailorMain::config.leftRotZ) + " deg");
        });
        ...
        QuestUI::BeatSaberUI::CreateUIButton(somemorebuttons->get_transform(), "Cancel", [](){
            ...
            QuestUI::ArrayUtil::First(Resources::FindObjectsOfTypeAll<Button*>(), [] (Button* x) { return x->get_name() == "BackButton"; })->get_gameObject()->SetActive(true);
        ...
        QuestUI::ArrayUtil::First(Resources::FindObjectsOfTypeAll<Button*>(), [] (Button* x) { return x->get_name() == "BackButton"; })->get_gameObject()->SetActive(false);
        ...
        SharedCoroutineStarter::get_instance()->StartCoroutine(CoroutineHelper::New(forceUpdateSliderText(posX, Round(SaberTailorMain::config.leftPosX, 1) + " cm")));
        SharedCoroutineStarter::get_instance()->StartCoroutine(CoroutineHelper::New(forceUpdateSliderText(posY, Round(SaberTailorMain::config.leftPosY, 1) + " cm")));
        SharedCoroutineStarter::get_instance()->StartCoroutine(CoroutineHelper::New(forceUpdateSliderText(posZ, Round(SaberTailorMain::config.leftPosZ, 1) + " cm")));
        SharedCoroutineStarter::get_instance()->StartCoroutine(CoroutineHelper::New(forceUpdateSliderText(rotX, std::to_string(SaberTailorMain::config.leftRotX) + " deg")));
        SharedCoroutineStarter::get_instance()->StartCoroutine(CoroutineHelper::New(forceUpdateSliderText(rotY, std::to_string(SaberTailorMain::config.leftRotY) + " deg")));
        SharedCoroutineStarter::get_instance()->StartCoroutine(CoroutineHelper::New(forceUpdateSliderText(rotZ, std::to_string(SaberTailorMain::config.leftRotZ) + " deg")));
